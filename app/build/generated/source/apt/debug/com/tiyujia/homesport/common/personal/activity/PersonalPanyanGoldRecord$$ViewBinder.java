...
public class PersonalPanyanGoldRecord$$ViewBinder<T extends com.tiyujia.homesport.common.personal.activity.PersonalPanyanGoldRecord> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558605, "field 'recycle'");
    target.recycle = finder.castView(view, 2131558605, "field 'recycle'");
  }
